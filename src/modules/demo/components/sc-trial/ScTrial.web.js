  ...
  return (
    <div>
      ...
      <Para>
        ...
        blanditiis, dicta dolore eligendi error eum fuga in ipsam magnam magni
        maxime nisi nulla ratione recusandae reiciendis reprehenderit sapiente
        tempora.
      </Para>

      <p css={commonSubtitle}>
